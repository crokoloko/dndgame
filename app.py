...
# Tutto il codice HTML, CSS e JS originale aggiornato per i JSON
game_html = f"""
<!DOCTYPE html>
<html lang="it">
<head>
    ...
    <style>
        ...
        .cell.wall {{ background: rgba(255,0,0,0.1); border: 1px solid rgba(255,255,255,0.05); }} /* Debug visivo per i muri */
...
<body onclick="playIntroOnce()">
    ...
    <script>
        ...
        async function caricaMappaCompleta(mapNumber) {{
            ...
            // 2. Carica il file JSON dei muri e loot
            try {{
